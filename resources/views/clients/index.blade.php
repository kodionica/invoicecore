                ...
                @foreach($clients as $client)
                    <tr role="row" class="{{ $loop->odd ? 'odd' : 'even' }}">
                        ...
                        <td>
                            ...
                            <span class="actions">
                                <a href="{{ route('clients.edit', $client) }}" class="action-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16"><path
